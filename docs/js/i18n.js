...
(function(){
  ...
  const strings = {
    "en": {
      ...
      "fsHelpTouchButtons": "Use the on-screen ESC, F9 and F10 buttons at the edges of the screen.",
    ...
    "nl": {
      ...
      "fsHelpTouchButtons": "Gebruik de knoppen ESC, F9 en F10 aan de randen van het scherm.",
    ...
    "uk": {
      ...
      "fsHelpTouchButtons": "Використовуйте кнопки ESC, F9 і F10 по краях екрана.",
