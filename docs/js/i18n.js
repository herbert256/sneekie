...
(function(){
  ...
  const strings = {
    "en": {
      ...
      "botLoadingCountdown": "One moment - Loading bot code - {seconds} seconds left",
      "vramEmpty": "empty",
      "vramHeart": "&#9829; heart (+10)",
      "vramClub": "&#9827; club (+25)",
    ...
    "nl": {
      ...
      "botLoadingCountdown": "Even geduld - botcode laden - nog {seconds} seconden",
      "vramEmpty": "leeg",
      "vramHeart": "&#9829; hart (+10)",
      "vramClub": "&#9827; klaver (+25)",
      "vramSmiley": "&#9786; smiley (-50)",
    ...
    "uk": {
      ...
      "botLoadingCountdown": "Хвилинку - завантаження коду бота - залишилося {seconds} с",
      "vramEmpty": "порожньо",
      "vramHeart": "&#9829; серце (+10)",
      "vramClub": "&#9827; трефа (+25)",
