...
(function(){
  ...
  const strings = {
    "en": {
      ...
      "fsHelpTouchButtons": "Use the on-screen ESC, Y, N, F9 and F10 buttons at the edges of the screen.",
    ...
    "nl": {
      ...
      "fsHelpTouchButtons": "Gebruik de knoppen ESC, J, N, F9 en F10 aan de randen van het scherm.",
    ...
    "uk": {
      ...
      "fsHelpTouchButtons": "Використовуйте кнопки ESC, Y, N, F9 і F10 по краях екрана.",
