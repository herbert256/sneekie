...
runtime UI strings, and old service-worker/cache cleanup. Sound starts on at page load; mute
is a session-only button state and `sneekie.muted` is cleared for old visitors.
